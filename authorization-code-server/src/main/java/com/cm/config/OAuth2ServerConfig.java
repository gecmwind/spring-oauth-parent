...
//            resources.resourceId(QQ_RESOURCE_ID).stateless(false);
        ...
        public void configure(HttpSecurity http) throws Exception {
            ...
            http.requestMatchers()
                    .antMatchers("/qq/**").and()
                .authorizeRequests()
                    .antMatchers("/qq/info/**").access("#oauth2.hasScope('get_user_info')").and()
                    .authorizeRequests().antMatchers("/qq/fans/**").access("#oauth2.hasScope('get_fanslist')").anyRequest().authenticated();
            // @formatter:on
    ...
    protected static class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
        ...
        public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
            ...
            clients.inMemory().withClient("aiqiyi")
                    ...
                    .secret("$2a$10$Ms.bhgMlmSF4FHv1cx8vjOV11r8btdpH/XGMyYpvM.ewS7m3hfrti")
